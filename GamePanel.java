...
public class GamePanel extends JPanel implements ActionListener {
	...
	final int x[] = new int[GAME_UNITS]; /* this array hold all of x coordinates of the body parts including head */
	final int y[] = new int[GAME_UNITS]; /* this array hold all of x coordinates */
	int bodyParts = 6;
	int applesEaten;
